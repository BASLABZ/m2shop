				...
				<div class="col-sm-9 bas-shadow" style="margin-bottom: 10px;">
					...
					<?php 
						$queryBeritaKategori = mysql_query("SELECT b.berita_id,b.berita_judul,b.mdd,b.berita_des,b.gambar,b.publish,k.kat_nm 
                                    from berita b INNER JOIN kategori k on b.kat_id = k.kat_id  where k.kat_id='".$id."' ORDER by b.berita_id DESC");
						while ($rowbarita = mysql_fetch_array($queryBeritaKategori)) {
					 ?>
					 <div class="blog-post-area">
						<div class="single-blog-post">
							...
							<a class="btn btn-primary" href="index.php?page=baca_berita&id=<?php echo $rowbarita['berita_id']; ?>">Baca Selengkapnya</a>
						</div>
					</div>
					<hr>
					<?php } ?>
