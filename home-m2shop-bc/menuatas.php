	<header id="header">
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.php" style="color: white; font-size: 20px;"><img src="assets/images/logo.jpg" alt="" class="img-circle dim_about" style="width: 60px; " /> M2SHOP</a>
						</div>
		...
		<div class="header-bottom" style="padding-bottom: 0px; padding-top: 0px;">
			<div class="container">
				<div class="row">
					<div class="col-sm-9">
