                    ...
                    <ul class="sf-menu">
                            ...
                            <ul class="dropdown">
                                ...
                                <li><a href="javascript:void(0)">Slider versions</a>
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="hero-carousel.html">Full Screen Carousel</a></li>
                                    </ul>
                                </li>
                        ...
                        <li><a href="javascript:void(0)">Pages</a>
                            <ul class="dropdown">
                                ...
                                <li><a href="dealer-search-results.html">Dealer Search Results</a></li>
                            </ul>
                        </li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mm-col col-md-5">
                                                ...
                                                <ul class="make-widget">
                                                    <li class="item"> <a href="results-list.html"><img src="images/logo_mercedes.png" alt=""></a></li>
                                                    <li class="item"> <a href="results-list.html"><img src="images/logo_vw.png" alt=""></a></li>
                                                    <li class="item"> <a href="results-list.html"><img src="images/logo_mazda.png" alt=""></a></li>
                                                    <li class="item"> <a href="results-list.html"><img src="images/logo_toyota.png" alt=""></a></li>
                                                    <li class="item"> <a href="results-list.html"><img src="images/logo_nissan.png" alt=""></a></li>
                                                    <li class="item"> <a href="results-list.html"><img src="images/logo_ford.png" alt=""></a></li>
                                                    <li class="item"> <a href="results-list.html"><img src="images/logo_bmw.png" alt=""></a></li>
                                                    <li class="item"> <a href="results-list.html"><img src="images/logo_audi.png" alt=""></a></li>
                                                </ul>
                                                <a href="results-list.html" class="basic-link">view all</a>
                                            </div>
                                        </div>
            ...
            <div class="container sp-cont">
                ...
                <div class="header-right">
                    <div class="user-login-panel">
                        <a href="#" class="btn btn-info btn-sm" data-toggle="modal" data-target="#loginModal">Login</a>
                        <a href="joinus.html" class="btn btn-primary btn-sm">SignUp</a>
                    </div>
                   ...
                   <!--  <div class="listing-header">
                    ...
                    <div class="listing-container">
                        <div class="carousel-wrapper">
                            <div class="row">
                                <ul class="owl-carousel carousel-fw" id="vehicle-slider" data-columns="3"  data-autoplay="5000" data-pagination="yes" data-arrows="no" data-single-item="no" data-items-desktop="4" data-items-desktop-small="3" data-items-tablet="2" data-items-mobile="1">
                                    <li class="item">
                                        <div class="vehicle-block format-standard">
                                            <a href="vehicle-details.html" class="media-box"><img src="images/car1.jpg" alt=""></a>
                                    ...
                                    <li class="item">
                                        <div class="vehicle-block format-standard">
                                            <a href="vehicle-details.html" class="media-box"><img src="images/car2.jpg" alt=""></a>
                                            <div class="vehicle-block-content">
                                    ...
                                    <li class="item">
                                        <div class="vehicle-block format-standard">
                                            <a href="vehicle-details.html" class="media-box"><img src="images/car4.jpg" alt=""></a>
                                            <div class="vehicle-block-content">
                                    ...
                                    <li class="item">
                                        <div class="vehicle-block format-standard">
                                            <a href="vehicle-details.html" class="media-box"><img src="images/car3.jpg" alt=""></a>
                                            <div class="vehicle-block-content">
                                                <span class="label label-default vehicle-age">2014</span>
                                        ...
                                        <ul class="owl-carousel" id="news-slider" data-columns="2" data-autoplay="" data-pagination="yes" data-arrows="yes" data-single-item="no" data-items-desktop="2" data-items-desktop-small="1" data-items-tablet="2" data-items-mobile="1">
                                            <li class="item">
                                                <div class="post-block format-standard">
                                                    <a href="single-post.html" class="media-box post-image"><img src="images/post2.jpg" alt=""></a>
                                            ...
                                            <li class="item">
                                                <div class="post-block format-standard">
                                                    <a href="single-post.html" class="media-box post-image"><img src="images/post1.jpg" alt=""></a>
                                                    <div class="post-actions">
                                            ...
                                            <li class="item">
                                                <div class="post-block format-standard">
                                                    <a href="single-post.html" class="media-box post-image"><img src="images/post3.jpg" alt=""></a>
                                                    <div class="post-actions">
                                        ...
                                        <ul class="owl-carousel carousel-fw" id="testimonials-slider" data-columns="2" data-autoplay="5000" data-pagination="no" data-arrows="no" data-single-item="no" data-items-desktop="2" data-items-desktop-small="1" data-items-tablet="1" data-items-mobile="1">
                                            <li class="item">
                                                <div class="testimonial-block">
                                                    ...
                                                    <div class="testimonial-avatar"><img src="images/user1.jpg" alt="" width="60" height="60"></div>
                                            ...
                                            <li class="item">
                                                <div class="testimonial-block">
                                                    ...
                                                    <div class="testimonial-avatar"><img src="images/user3.jpg" alt="" width="60" height="60"></div>
                                                    <div class="testimonial-info">
                                                        <div class="testimonial-info-in">
                                            ...
                                            <li class="item">
                                                <div class="testimonial-block">
                                                    ...
                                                    <div class="testimonial-avatar"><img src="images/user2.jpg" alt="" width="60" height="60"></div>
                                                    <div class="testimonial-info">
                                                        <div class="testimonial-info-in">
                        ...
                        <div class="col-md-9 col-sm-8">
                            <div class="row">
                                <ul class="owl-carousel" id="make-carousel" data-columns="5" data-autoplay="6000" data-pagination="no" data-arrows="no" data-single-item="no" data-items-desktop="5" data-items-desktop-small="4" data-items-tablet="3" data-items-mobile="3">
                                    <li class="item"> <a href="results-grid.html"><img src="images/logo_mercedes.png" alt=""></a></li>
                                    <li class="item"> <a href="results-grid.html"><img src="images/logo_vw.png" alt=""></a></li>
                                    <li class="item"> <a href="results-grid.html"><img src="images/logo_mazda.png" alt=""></a></li>
                                    <li class="item"> <a href="results-grid.html"><img src="images/logo_bmw.png" alt=""></a></li>
                                    <li class="item"> <a href="results-grid.html"><img src="images/logo_ford.png" alt=""></a></li>
                                    <li class="item"> <a href="results-grid.html"><img src="images/logo_toyota.png" alt=""></a></li>
                                    <li class="item"> <a href="results-grid.html"><img src="images/logo_ferrari.png" alt=""></a></li>
                                    <li class="item"> <a href="results-grid.html"><img src="images/logo_nissan.png" alt=""></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
